...
function relationText(day,annualSi){const g=tenGod(day.si,annualSi);return `${g}(${GOD_TEXT[g]})의 상징이 전면에 들어오는 해로 읽을 수 있습니다. 이것은 사건 예측이 아니라 올해 무엇을 점검해 볼지 정하는 전통적 참고 언어입니다.`}
